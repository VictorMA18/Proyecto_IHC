            ...
            if cam_check[cname[VideoHandler.camName]] == 0:
                ...
                if f % 2 == 0:
                    ...
                    if np.abs(valence) < 0.1 and np.abs(arousal) < 0.1:
                        ...
                        final_emot = emotion_list[3]  # pleasedf
                ...
                if (config['camshow'] == 'on'):
                    ...
                    cv2.rectangle(orig_image, (0,0), (450,600), (255,255,255), -1) 
                    cv2.rectangle(orig_image, (0,0), (450,600), (0,0,0), 3)
                    cv2.rectangle(orig_image, (50,150), (300,400), (84,156,239), -1) #Fondo de los cuadrados
                    cv2.line(orig_image, (50,275), (300,275), (255,255,255), 1)
                    cv2.line(orig_image, (175,150), (175,400), (255,255,255), 1)
                    cv2.putText(orig_image, 'Feliz', (200, 212), cv2.FONT_HERSHEY_SIMPLEX, .75, (0,245,245), 2)
                    cv2.putText(orig_image, 'Tranquilo', (185, 337), cv2.FONT_HERSHEY_SIMPLEX, .75, (245,0,90), 2)
                    cv2.putText(orig_image, 'Enojado', (73, 212), cv2.FONT_HERSHEY_SIMPLEX, .75, (5,5,253), 2)
                    cv2.putText(orig_image, 'Triste', (85, 337), cv2.FONT_HERSHEY_SIMPLEX, .75, (244,55,7), 2)
                    ...
                    cv2.putText(orig_image, 'Valencia: {0:.2f}'.format(valence_value), (5, 25), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
                    cv2.putText(orig_image, 'Excitacion: {0:.2f}'.format(arousal_value), (5, 55), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
                    cv2.putText(orig_image, 'Emocion Discreta: {}'.format(final_emot), (5, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
                    
                    cv2.putText(orig_image, 'Espacio excitacion-valencia', (5, 440), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 0), 2)
                    cv2.putText(orig_image, 'Eje horizontal: Valencia', (5, 480), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 0), 1)
                    cv2.putText(orig_image, 'Eje vertical: excitacion', (5, 520), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 0), 1)
                    cv2.putText(orig_image, 'Pesas preentrenadas AVCE @ INHA', (5, 575), cv2.FONT_HERSHEY_SIMPLEX, .75, (0, 0, 0), 2)
                    # cv2.putText(orig_image, '{}'.format(emoji.emojize(":grinning_face_with_big_eyes:")), (0, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
                    if fd_signal == 1:
                        cv2.putText(orig_image, 'Rostro detectado', (5, 125), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 200), 2)
                    elif fd_signal == 0:
                        cv2.putText(orig_image, 'Rostro no detectado', (5, 125), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 200, 0), 2)
...
class FER_INT_ALG():
    ...
    def __init__(self):
        ...
        global emotion_list
        global emot_region
        emotion_list = ["enojado", "triste", "feliz", "tranquilo", "neutral"]
        emot_region = ""
